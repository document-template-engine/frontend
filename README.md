...
- 5 Дополнительная документация
  - [5.1 Полный деплой среды React-CRA и инструментов](#)
  - [5.2 Дополнительная информация по работе с Git и Github](#)
  - [5.3 Документация по работе с Redux и RTK](#)
  - [5.4 Документация по работе с TypeScript](#)
  - [5.5 Документация по работе с Storybook](#)
