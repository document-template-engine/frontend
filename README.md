...
## Про pull-request
Pull-request - удобный инструмент для командрой работы в системе контроля версий. Он упрощает обсуждение изменений кода, сделанные разными участниками, и позволяет быстро встраивать утвержденный код в рабочую ветку проекта.

**Как это работакет**
1. Когда учатник проекта пушит изменения в ветку репозитория, «Гитхаб» это замечает и предлагает создать пул реквест из текущей ветки. Появляется кнопка “Compare & pull request”:
![“Compare & pull request”](https://pictures.s3.yandex.net/resources/github_mm_10_1602446657.jpg)
2. В интерфейсе над кнопкой “Create pull request” — меню с ветками и репозиториями.
Дальше важно не перепутать: первая ветка отвечает за то, *куда отправятся изменения*, вторая — *откуда (из какой ветки) эти изменения придут*. «Направление изменений» указывает стрелка.
Вы можете открыть пул реквест между ветками внутри одного репозитория.
Здесь видно, какие файлы изменены, откуда и куда они попадут:
![Создание pull-request](https://pictures.s3.yandex.net/resources/github_mm_11_v02_1602446676.jpg)
3. Пришло время зелёной кнопки: “Create pull request”. После не забудьте заполнить название изменения и кратко опишите, что именно вы сделали.
После нажатия кнопки “Create pull request” — вы создаёте пул реквест в репозитории. Во вкладке “Pull requests” видны обсуждения изменений, которые вы предложили:
![Обсуждения](https://pictures.s3.yandex.net/resources/github_mm_13_1602446717.jpg)
4. Если код не понравится другому участнику команды, он может оставить комментарий:
![Комментарии](https://pictures.s3.yandex.net/resources/github_mm_14_v02_1602446740.jpg)
5. Когда поправите код и сделаете коммит, изменения автоматически добавятся в пул реквест. Их можно посмотреть во вкладке “Commits”:
![История коммитов](https://pictures.s3.yandex.net/resources/github_mm_15_1602446789.jpg)
6. Новый коммит автоматически отобразится во вкладке “Conversation”:
![Новый коммит](https://pictures.s3.yandex.net/resources/github_mm_16_v02_1602446811.jpg)
7. Когда код будет всех устраивать, тимлид (или другой ответственный человек) нажмёт заветную кнопку “Merge”, и изменения попадут в ветку main.


NB! Если git не предложит создать pull-request автоматически, это можно сделать вручную во вкладке pull-request.
![Создать pull-request вручную](image-6.png)
