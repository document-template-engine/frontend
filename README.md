...
2. Необходимо локально установить зависимости из проекта.  
   `npm i`
3. В режиме разработки приложение откроется на 3000 порту.  
   `npm run start`

### Как работать над задачей:

1. Подтянуть актуальные изменения изменения из ветки **develop**.  
...
- Fix - дебагинг и всевозможные фиксы кода. _Fix/Header - ветка для починки компонента fix._  
