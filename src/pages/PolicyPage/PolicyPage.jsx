...
const PolicyPage = () => (
	<main className="PolicyPage">
		<header className="PolicyPage__header">
			<div className="PolicyPage__header__logo" />
			<Link
				to={{ pathname: '/signin' }}
				className="PolicyPage__header__login-button"
			>
				Вход
			</Link>
		</header>
		<h2 className="PolicyPage__title">
			Политика в отношении обработки персональных данных
		</h2>
		<h3 className="PolicyPage__paragraph">1. Общие положения</h3>
		<p className="PolicyPage__text">
			...
			персональных данных, предпринимаемые Шаблонизатор Документов (далее —
			Оператор).
		</p>
		<ul className="PolicyPage__list">
			<li className="PolicyPage__list-text">
			...
			<li className="PolicyPage__list-text">
				...
				<a className="PolicyPage__link" href="https://documents-template.site">
					https://documents-template.site
				</a>
			</li>
		</ul>
		...
		<ul className="PolicyPage__list">
			<li className="PolicyPage__list-text">
				...
				персональных данных с помощью средств вычислительной техники. содержания
		...
		<ul className="PolicyPage__list">
			...
			<li className="PolicyPage__list-text">
				...
				info@documents-template.site с пометкой «Актуализация персональных
				данных».
			</li>
			<li className="PolicyPage__list-text">
			...
			<p className="PolicyPage__text">
				...
				info@documents-template.site с пометкой «Отзыв согласия на обработку
				персональных данных».
			</p>
			<li className="PolicyPage__list-text">
		...
		<h3 className="PolicyPage__paragraph">12. Заключительные положения</h3>
		<ul className="PolicyPage__list">
			<li className="PolicyPage__list-text">
				...
				Оператору с помощью электронной почты info@documents-template.site
			</li>
			<li className="PolicyPage__list-text">
			...
			<li className="PolicyPage__list-text">
				...
				Интернет по адресу&nbsp;
				<a
					className="PolicyPage__link"
					href="https://documents-template.site/Policy/"
				>
					https://documents-template.site/policy
				</a>
			</li>
		</ul>
	</main>
