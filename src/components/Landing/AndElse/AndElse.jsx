		...
		<section className="and-else">
			...
			<div className="and-else__container">
				<Figure
					...
					subtitle="При заполнении документов"
				/>
				<Figure
					image={clockImg}
					title="Сэкономить время"
					subtitle="И потратить его на более важные и приятные дела"
				/>
				<Figure
					image={smileImg}
					title="Быть спокойным"
					subtitle="Что документ заполнен по корректной и актуальной форме"
				/>
				<Figure
					image={downloadImg}
					title="Скачать файл"
					subtitle="Готовый к печати и отправке по электронной почте"
				/>
			</div>
		</section>
	);
